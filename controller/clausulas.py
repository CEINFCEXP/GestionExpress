...
df.columns = [
    ...
    'norma_relacionada', 'consecuencia', 'frecuencia', 'inicio_cumplimiento', 
    'fin_cumplimiento', 'observacion'
]
...
insert_query = """
    INSERT INTO clausulas (
        control, etapa, clausula, modificacion, contrato_concesion, 
        tema, subtema, descripcion_clausula, tipo_clausula, 
        norma_relacionada, consecuencia, frecuencia, 
        inicio_cumplimiento, fin_cumplimiento, observacion
